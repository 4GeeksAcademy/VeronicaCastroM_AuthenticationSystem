...
def register():
     ...
     if "password" not in body:
        raise APIException("Debes enviar el campo password", status_code=400)
...
def get_info():
    ...
    return jsonify({"hola": "el token funciona", "identidad del usuario": identity}), 200
